...
#### 2.1.46
 - `fix` 修复 cos 支持ext appid
#### 2.1.45
 - `fix` 修复 cos 版本安全问题
#### 2.1.44
 - `fix` 修复 调试问题
#### 2.1.43
 - `fix` 升级部分有安全问题的 npm 依赖
#### 2.1.42
 - `fix` getDevSourceMap sleep 参数默认值改为 0
#### 2.1.41
 - `fix` getDevSourceMap sleep 参数不生效的问题
#### 2.1.40
 - `fix` getDevSourceMap 支持 sleep 参数，单位是秒
#### 2.1.39
 - `fix` ci 编译 setting 不生效的问题
#### 2.1.38
 - `fix` 修复内存变大问题
#### 2.1.37
