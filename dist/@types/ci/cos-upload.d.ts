...
export declare function uploadByCosSafely(buffer: Buffer, commitUrl: string, project: IProject, robot: any, businessType: TBusinessType, onProgressUpdate?: (progressData: any) => void, aiticket?: string): Promise<{
    fallback: boolean;
    body?: any;
    uploadCOSCostTime?: number;
}>;
...
}, onProgress?: (progressData: any) => void, aiticket?: string): Promise<{
    fallback: boolean;
    body?: any;
    uploadCOSCostTime?: number;
}>;
