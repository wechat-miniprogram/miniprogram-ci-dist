...
declare interface IAgentConfig {
    skills?: IAgentSkillConfig[];
    /** 页面元信息 json 文件路径（相对 miniprogramRoot），打包与本地工具开发均依赖该文件 */
    pageMetadata?: string;
}

declare interface IAgentSkillConfig {
    name?: string;
    description?: string;
    path?: string;
    [key: string]: unknown;
 ...
 * @public
 */
export declare type ModuleType = 'Js' | 'Wxml' | 'Wxss' | 'Wxs' | 'Agent' | 'Config' | 'MainPackage' | 'SubPackage' | 'WorkerSubPackage' | 'Page' | 'Component' | 'Plugin' | 'Worker' | 'FunctionalPages' | 'ContextModule' | 'PluginPackage' | 'GameMainPackage' | 'GameSubPackage';
