...
export declare abstract class BaseGraph {
    ...
    private _changedSinceLastBuild;
    private _artifactInitialized;
    private _lastBuildChangedFiles;
    private _lastBuildIsInitial;
    private _buildArtifactPromise;
    ...
    protected ensureBuildArtifacts(): Promise<void>;
    ...
    private appendAdditionalCompileFiles;
    private readFile;
    private tranform;
    private generate;
    private compileCode;
