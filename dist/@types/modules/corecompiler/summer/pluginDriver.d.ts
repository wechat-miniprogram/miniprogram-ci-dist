...
export declare function getPluginContext(plugin: MiniProgramSummer.SummerPlugin, graph: BaseGraph, driver: PluginDriver): MiniProgramSummer.PluginContext;
export declare class PluginDriver {
    ...
    runBuildStart(context: MiniProgramSummer.BuildStartContext): Promise<void>;
    runBuildEnd(context: MiniProgramSummer.BuildEndContext): Promise<void>;
    private matchesBuildFilter;
}
export {};
