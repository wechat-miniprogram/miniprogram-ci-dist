...
export declare class SummerCompiler extends BaseCoreCompiler {
    ...
    private _idleCompileScheduler;
    constructor(project: MiniProgramCore.IPreCompileProject, cachePath: string, projectInfo: MiniProgramDevtools.IDevtoolsProjectInfo, devtoolMessagehub: IMessageHub, analyzer: Analyzer | null, _filterFactory?: MiniProgramDevtools.IFilterFactory | undefined, onInitFinished?: ((e?: Error) => void) | undefined, ownerBuilderId?: string);
    ...
    updateIdleCompileLaunchPath(launchPath: string): void;
